...
import {Grid, Image, Card, Label, Button, Icon, Form} from 'semantic-ui-react';
                            ...
                            <Card fluid>
                                ...
                                <Form>
                                    <div className="ui action input fluid">
                                        ...
                                        <button type="submit" className="ui button orange" disabled={comment.trim() === ''} onClick={submitComment}>Submit</button>
                                    </div>
                                </Form>
                                </Card.Content>
                            </Card>
